...
def main() -> None:
    ...
    parser.add_argument('--bin', nargs='+', type=int, required=True, default=[8, 8, 8, 6, 6, 6, 4, 4, 2, 2, 2, 2], help="bin")
    ...
    infer_type = "rebuttal-other-model-cape/"
    ...
    with open(f"benchmark/{infer_type}/{model_name+'-'+args.large_path.split('/')[-1]}/metrics_{dataset+time_tag}_beam{num_beams}_batch{batch_size}.jsonl", mode='w', encoding='utf-8') as output:
